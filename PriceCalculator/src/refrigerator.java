...
class refrigerator extends JFrame implements ActionListener
{
	...
	JLabel smg = new JLabel("SAMSUNG");
	JLabel sny = new JLabel("LG");
	JLabel lg = new JLabel("HAIER");
	JLabel mi = new JLabel("WHIRLPOOL");
	 ...
	 public void actionPerformed(ActionEvent event)
	{
		...
		Object select1 = cmb1.getSelectedItem();
			if(select1.toString().equals("190 Lt"))
			{
				p = i*14000;		
				...
				if(select1.toString().equals("215 Lt"))
				{
				p = i*16000;		
				String result1 = String.valueOf(p);
				tf5.setText(result1);
		...
		Object select2 = cmb2.getSelectedItem();
			if(select2.toString().equals("190 Lt"))
			{
				q = j*14500;		
				...
				if(select2.toString().equals("240 Lt"))
				{
				q = j*20000;		
				String result2 = String.valueOf(q);
				tf6.setText(result2);
		...
		Object select3 = cmb3.getSelectedItem();
			if(select3.toString().equals("170 Lt"))
			{
				r = k*13000;		
				...
				if(select3.toString().equals("335 Lt"))
				{
				r = k*24000;		
				String result3 = String.valueOf(r);
				tf7.setText(result3);
		...
		Object select4 = cmb4.getSelectedItem();
			if(select4.toString().equals("192 Lt"))
			{
				s = l*15000;		
				...
				if(select4.toString().equals("253 Lt"))
				{
				s = l*18000;		
				String result4 = String.valueOf(s);
				tf8.setText(result4);
		...
		ss2 = p+q+r+s;
		String result = String.valueOf(ss2);
		tf9.setText(result);
