...
class television extends JFrame implements ActionListener
{
	...
	JLabel sny = new JLabel("SONY");
	JLabel lg = new JLabel("LG");
	JLabel mi = new JLabel("REDMI TV");
	 ...
	 public void actionPerformed(ActionEvent event)
	{
		...
		Object select1 = cmb1.getSelectedItem();
			if(select1.toString().equals("32 inch"))
			{
				p = i*32000;		
				...
				if(select1.toString().equals("43 inch"))
				{
				p = i*40000;		
				String result1 = String.valueOf(p);
				tf5.setText(result1);
		...
		Object select2 = cmb2.getSelectedItem();
			if(select2.toString().equals("32 inch"))
			{
				q = j*32000;		
				...
				if(select2.toString().equals("43 inch"))
				{
				q = j*40000;		
				String result2 = String.valueOf(q);
				tf6.setText(result2);
		...
		Object select3 = cmb3.getSelectedItem();
			if(select3.toString().equals("32 inch"))
			{
				r = k*32000;		
				...
				if(select3.toString().equals("43 inch"))
				{
				r = k*40000;		
				String result3 = String.valueOf(r);
				tf7.setText(result3);
		...
		Object select4 = cmb4.getSelectedItem();
			if(select4.toString().equals("32 inch"))
			{
				s = l*32000;		
				...
				if(select4.toString().equals("43 inch"))
				{
				s = l*40000;		
				String result4 = String.valueOf(s);
				tf8.setText(result4);
		...
		ss1 = p+q+r+s;
		String result = String.valueOf(ss1);
		tf9.setText(result);
